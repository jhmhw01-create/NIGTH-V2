...
test('current home photographs and functional destinations remain present',async()=>{
 ...
 for(const image of ['home-hero-night.webp','home-about-night.webp','home-profile-doha.webp','home-profile-ihwan.webp','home-profile-jiwoo.webp','home-profile-taehoon.webp','home-profile-woohyun.webp','night-lightstick-v2-07-design-evolution.webp'])assert(home.includes(image));
 for(const href of ['discography.html','gallery.html','contents.html','archive.html','notice.html','fanclub.html','five-voices.html','#members','listen.html'])assert(home.includes(href));
 ...
 assert(!home.includes('assets/images/2029/rest/next-time.webp'));
 assert(!home.includes('listen.html#next-time'));
 assert(!home.includes('discography.html#rest'));
