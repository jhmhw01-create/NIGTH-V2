...
export function ArchivePage({route}) {
  ...
  const isStoryPhoto=node=>['fm-photo','sg-photo','behind-photo','travel-photo'].some(cls=>classes(node).has(cls));
  ...
  const stagePhoto=stageItem?{full:stageItem.props['data-full'],thumb:stageImage?.props.src,alt:stageTitle,title:stageTitle}:null;
