...
export function CollectionPage({route,data,dimensions={}}){
  ...
  return <><main className="container nc-main">
    <div className="nc-heading"><p className="nc-kicker">{luna?'A DAY WITH YOU':'SPECIAL CONCEPT ARCHIVE'}</p><h1>{luna?'WITH LUNA':'IF : NIGHT'}</h1><p>{luna?'데이트부터 집에 도착한 뒤의 안부까지, LUNA와 함께하는 세 장면.':'만약 다른 모습으로 만났다면. NIGHT의 또 다른 가능성을 담은 IF 콘셉트 화보.'}</p></div>
