...
export function App({route='index.html'}) {return <><Header activeNav={route==='archive.html'?'ARCHIVE':route.startsWith('member-')?'MEMBERS':active[route]} />{route==='index.html'?<HomePage />:route==='archive.html'?<SearchArchive />:<ArchivePage route={route} />}<Footer /></>;}
