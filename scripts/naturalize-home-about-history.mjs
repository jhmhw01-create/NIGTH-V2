...
// HOME
{
  ...
  const edits=[
    ...
    ['음악과 활동 기록, 공식 콘텐츠와 최신 소식까지 NIGHT를 한곳에서 만나보세요.','앨범과 공연, 공식 콘텐츠와 최신 소식까지 NIGHT의 활동을 한곳에서 만나보세요.','home explore'],
    ['데뷔와 멤버 변화, 공연과 팬클럽까지 이어지는 NIGHT의 공식 활동 연혁.','데뷔부터 앨범, 공연, 팬클럽 활동까지 NIGHT의 주요 순간을 시간순으로 확인하세요.','home history card'],
    ['콘셉트 포토와 공식 활동 사진, 캠페인 비주얼을 모아보세요.','콘셉트 포토와 활동 사진, 다양한 공식 비주얼을 모아보세요.','home gallery card']
  ];
...
// ABOUT
{
  ...
  page.headHtml=mustReplace(page.headHtml,
    'NIGHT의 그룹 프로필, 음악과 퍼포먼스 정체성, 현재 멤버, 변화와 주요 기록을 소개하는 공식 그룹 페이지.',
    'NIGHT의 그룹 프로필과 음악, 퍼포먼스, 현재 멤버와 주요 활동을 소개하는 공식 페이지.',
    'about meta');
  const edits=[
...
// HISTORY
{
  ...
  const edits=[
    ...
    ['ANGEL과 FALLEN, 빛과 상흔 사이의 경계를 따라가는 WINGS의 공식 기록.','미니앨범 WINGS 발표. 타이틀곡과 공식 비주얼, 활동 기록을 함께 공개했다.','history wings'],
