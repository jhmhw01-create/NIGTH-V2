...
export async function buildReactPages() {
  ...
  for(const route of routes) {
    ...
    const body=page.beforeHeaderHtml+'<div id="night-react-root">'+markup+'</div><noscript><style>.reveal{opacity:1!important;transform:none!important}.nav-links{display:flex!important;flex-wrap:wrap}</style></noscript><script type="module" src="assets/js/'+clientFile+'"></script>';
