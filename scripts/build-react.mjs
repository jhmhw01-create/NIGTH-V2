...
export async function buildReactPages() {
  ...
  for(const route of routes.slice(1)) {
    ...
    trees[route]=pageTree(renderCollections(albumRoutes.includes(route)?albumMarkup(page):page.contentHtml,collections));
  }
  ...
  console.log('22 React routes pre-rendered; other 30 routes unchanged.');
}
