...
React 전환 3단계: HOME·DISCOGRAPHY·CONTENTS·NOTICE·FANCLUB·GALLERY와 해당 페이지의 메뉴·푸터는 React로 동작합니다. 콘텐츠·공지 필터, 갤러리 컬렉션 및 사진 필터와 이미지 확대는 React에서 처리합니다. 팬클럽 1~6기와 2027·2028 시즌그리팅의 기존 링크 및 미디어를 유지합니다. 빌드 시 본문을 미리 렌더링하며, 다른 46개 페이지는 기존 HTML 생성 방식을 유지합니다. 전체 React SPA 전환은 아직 아닙니다.
